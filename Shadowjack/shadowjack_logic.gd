...
func _on_stand_pressed():
	...
	await get_tree().create_timer(0.5).timeout
	var dealer_hand_container = $DealerHand
...
func create_card_data():
	...
	card_images["back"] = [0, "res://assets/images/card_back_pix.png"]
...
func generate_card(hand, back=false):
	...
	if hand == "player":
		card_hand_container = $PlayerHand
		...
		card_hand_container = $DealerHand
